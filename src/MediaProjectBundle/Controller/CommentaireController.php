...
use MediaProjectBundle\Entity\Commentaire;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('MediaProjectBundle:Commentaire')->findAll();

        return $this->render('@MediaProject/commentaire/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MediaProjectBundle\Form\CommentaireType', $commentaire);
        ...
        return $this->render('@MediaProject/commentaire/new.html.twig', array(
    ...
    public function showAction(Commentaire $commentaire)
    {
        ...
        return $this->render('@MediaProject/commentaire/show.html.twig', array(
            'commentaire' => $commentaire,
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('MediaProjectBundle\Form\CommentaireType', $commentaire);
        ...
        return $this->render('@MediaProject/commentaire/edit.html.twig', array(
            'commentaire' => $commentaire,
